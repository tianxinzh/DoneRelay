...
Use Node.js 22+ and run `npm ci --ignore-scripts`, `npm test`, and `npm pack --dry-run`. There are no runtime dependencies. Keep the service single-instance and the skill portable.
