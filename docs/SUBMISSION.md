...
Updated 2026-09-14 for `0.1.0-alpha.6`. Copy fields only after validating the exact submitted commit. The publisher must supply identity, contact details, accounts, and attestations personally. This file is not evidence of a passed review.
